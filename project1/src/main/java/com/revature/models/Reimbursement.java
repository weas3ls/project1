...
public class Reimbursement {
    ...
    // Constructor
    // public Reimbursement(int id, BigDecimal amount, int requestee_id, int
    // resolvee_id, int status_id, int type_id) {
    // super();
    // this.id = id;
    // this.amount = amount;
    ...
    public String toString() {
        return (this.id + "\t" + this.amount + "\t" + this.requestee_id + "\t" + this.requestee_name + "\t"
                + this.resolvee_id + "\t" + this.resolvee_name + "\t" + this.status + "\t" + type);
    }
